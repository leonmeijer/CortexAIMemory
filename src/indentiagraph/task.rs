//! IndentiaGraph Task operations

use super::client::{pascal_to_snake_case, IndentiaGraphClient, WhereBuilder};
use super::models::*;
...
impl IndentiaGraphClient {
    ...
    /// Helper to convert IndentiaGraph node to TaskNode
    ...
    /// Convert a IndentiaGraph Node to a StepNode
