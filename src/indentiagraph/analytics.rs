//! IndentiaGraph Analytics operations (communities, health, GDS metrics)
...
impl IndentiaGraphClient {
    ...
    pub async fn get_code_health_report(
        ...
        use crate::indentiagraph::models::{CodeHealthReport, CouplingMetrics, GodFunction};
    ...
    pub async fn batch_update_file_analytics(
        ...
        // Chunk to avoid overloading IndentiaGraph heap (tx_state = ON_HEAP)
    ...
    /// and GC death spirals. The query plan is cached by IndentiaGraph since the
    ...
    /// since IndentiaGraph doesn't support nested arrays in UNWIND.
    ...
    /// Read a context card from IndentiaGraph cc_* properties for a single file.
    ///
