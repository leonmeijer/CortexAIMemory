//! IndentiaGraph Workspace operations

use super::client::{pascal_to_snake_case, snake_to_pascal_case, IndentiaGraphClient};
use super::models::*;
use anyhow::Result;
use neo4rs::query;
use uuid::Uuid;
...
impl IndentiaGraphClient {
    ...
    /// Helper to convert IndentiaGraph node to WorkspaceNode
    ...
    /// Helper to convert IndentiaGraph node to WorkspaceMilestoneNode
    ...
    /// Helper to convert IndentiaGraph node to ResourceNode
    ...
    /// Helper to convert IndentiaGraph node to ComponentNode
