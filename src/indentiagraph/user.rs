//! IndentiaGraph User / Auth operations
...
impl IndentiaGraphClient {
    ...
    pub async fn upsert_user(&self, user: &UserNode) -> Result<UserNode> {
        use crate::indentiagraph::models::AuthProvider;
    ...
    /// Parse a IndentiaGraph Node into a UserNode
    ...
    pub async fn validate_refresh_token(
        &self,
        token_hash: &str,
    ) -> Result<Option<crate::indentiagraph::models::RefreshTokenNode>> {
        let q = query(
        ...
        match result.next().await? {
            Some(row) => {
                ...
                let token = crate::indentiagraph::models::RefreshTokenNode {
