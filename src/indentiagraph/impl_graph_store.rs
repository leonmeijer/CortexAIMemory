//! `GraphStore` implementation for `IndentiaGraphClient`.
//!
//! Every method simply delegates to the corresponding inherent method on `IndentiaGraphClient`.
...
#[async_trait]
impl GraphStore for IndentiaGraphClient {
    // ========================================================================
    // Project operations
    // ========================================================================
    ...
    ) -> anyhow::Result<crate::indentiagraph::models::CodeHealthReport> {
    ...
    async fn validate_refresh_token(
        &self,
        token_hash: &str,
    ) -> anyhow::Result<Option<crate::indentiagraph::models::RefreshTokenNode>> {
    ...
    async fn get_neural_metrics(
        &self,
        project_id: Uuid,
    ) -> anyhow::Result<crate::indentiagraph::models::NeuralMetrics> {
    ...
    async fn compute_churn_scores(
        &self,
        project_id: Uuid,
    ) -> anyhow::Result<Vec<crate::indentiagraph::models::FileChurnScore>> {
        self.compute_churn_scores(project_id).await
    }

    async fn batch_update_churn_scores(
        &self,
        updates: &[crate::indentiagraph::models::FileChurnScore],
    ) -> anyhow::Result<()> {
    ...
    async fn compute_knowledge_density(
        &self,
        project_id: Uuid,
    ) -> anyhow::Result<Vec<crate::indentiagraph::models::FileKnowledgeDensity>> {
        self.compute_knowledge_density(project_id).await
    }

    async fn batch_update_knowledge_density(
        &self,
        updates: &[crate::indentiagraph::models::FileKnowledgeDensity],
    ) -> anyhow::Result<()> {
    ...
    async fn compute_risk_scores(
        &self,
        project_id: Uuid,
    ) -> anyhow::Result<Vec<crate::indentiagraph::models::FileRiskScore>> {
        self.compute_risk_scores(project_id).await
    }

    async fn batch_update_risk_scores(
        &self,
        updates: &[crate::indentiagraph::models::FileRiskScore],
    ) -> anyhow::Result<()> {
    ...
    // ========================================================================
    // Analysis Profile operations (delegates to indentiagraph/profile.rs)
    // ========================================================================
    ...
    // ========================================================================
    // Topology Firewall (delegates to indentiagraph/topology.rs)
    // ========================================================================
    ...
    // ========================================================================
    // Skill operations (delegates to indentiagraph/skill.rs)
    // ========================================================================
    ...
    async fn get_skill_members(
        ...
        Vec<crate::indentiagraph::models::DecisionNode>,
    )> {
    ...
    async fn search_notes_fts(
        &self,
        query: &str,
        filters: &crate::notes::NoteFilters,
    ) -> anyhow::Result<Vec<crate::notes::NoteSearchHit>> {
        self.search_notes_fts(query, filters).await
    }
    ...
    async fn search_decisions_fts(
        ...
        limit: usize,
        project_id: Option<&str>,
    ) -> anyhow::Result<Vec<(crate::indentiagraph::models::DecisionNode, f64)>> {
    ...
    async fn search_code_fts(
        ...
        project_id: Option<uuid::Uuid>,
        language: Option<&str>,
    ) -> anyhow::Result<Vec<crate::indentiagraph::models::CodeSearchHit>> {
    ...
    async fn add_episode(
        &self,
        req: crate::indentiagraph::models::CreateEpisodeRequest,
    ) -> anyhow::Result<crate::indentiagraph::models::EpisodeNode> {
    ...
    async fn get_episodes(
        ...
        group_id: Option<&str>,
        limit: usize,
    ) -> anyhow::Result<Vec<crate::indentiagraph::models::EpisodeNode>> {
    ...
    async fn search_notes_at_time(
        ...
        project_id: Option<uuid::Uuid>,
        limit: usize,
    ) -> anyhow::Result<Vec<crate::notes::Note>> {
