//! IndentiaGraph Topology Firewall operations (GraIL Plan 3)
//!
...
impl IndentiaGraphClient {
    ...
    /// Convert a IndentiaGraph node to a [`TopologyRule`].
    ...
    ///
    /// **Performance target: <50ms** — Only fetches rules from IndentiaGraph (1 query),
