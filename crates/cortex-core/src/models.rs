//! Core domain models — graph nodes, plan types, workspace entities.
//!
//! These are backend-agnostic data types shared across all CortexAIMemory crates.
...
pub struct ChatSessionNode {
    ...
    /// Additional directories exposed to Claude CLI (serialized as JSON array string in IndentiaGraph)
    #[serde(default)]
...
///
/// Events are stored as `(:ChatSession)-[:HAS_EVENT]->(:ChatEvent)` in IndentiaGraph.
...
// ============================================================================
// Constructor methods for plan/task/step/decision/constraint nodes
// ============================================================================
